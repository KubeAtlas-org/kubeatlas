...
declare type Config = {
  ...
  hiddenKinds?: string[]
  detailHeight?: number
  detailHeights?: Record<string, number>
  persistDetailExpansion?: boolean
  persistDetailTab?: boolean
  detailTab?: 'info' | 'yaml' | 'events'
  detailTabExpanded?: { info: boolean | null; yaml: boolean | null; events: boolean | null }
}
